...
<p>See <a href="?page=docs&action=Developer/AbstractsClass/abstract-model-attributes">Attributes</a> for more details</p>
    ...
    <h2 class="mt-4">Common Operations Quick Reference</h2>
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>Get by multiple IDs</td>
                    <td><code>getByIds($ids)</code></td>
                    <td><span class="badge bg-success">Model</span></td>
                    <td><code>$model->getByIds([1,2,3])</code></td>
                </tr>
                <tr>
                    <td>Get empty record</td>
                    <td><code>getEmpty($data)</code></td>
                    <td><span class="badge bg-success">Model</span></td>
                    <td><code>$model->getEmpty(['status' => 1])</code></td>
                </tr>
                <tr>
                    <td>Get first record</td>
                    <td><code>getFirst($field, $dir)</code></td>
                    <td><span class="badge bg-success">Model</span></td>
                    <td><code>$model->getFirst('created_at', 'desc')</code></td>
                </tr>
                <tr>
                    <td>Query with WHERE</td>
                    <td><code>where($condition, $params)</code></td>
                    <td><span class="badge bg-primary">Query</span></td>
                    <td><code>$model->where('price > ?', [10])</code></td>
                </tr>
                <tr>
                    <td>Query with WHERE IN</td>
                    <td><code>whereIn($field, $values)</code></td>
                    <td><span class="badge bg-primary">Query</span></td>
                    <td><code>$model->whereIn('id', [1,2,3])</code></td>
                </tr>
                <tr>
                    <td>Filter by relationship</td>
                    <td><code>whereHas($relation, $condition)</code></td>
                    <td><span class="badge bg-primary">Query</span></td>
                    <td><code>$model->whereHas('reviews', 'rating > ?', [4])</code></td>
                </tr>
                <tr>
                    <td>Select specific fields</td>
                    <td><code>select($fields)</code></td>
                    <td><span class="badge bg-primary">Query</span></td>
                    <td><code>$model->select(['id', 'name'])</code></td>
                </tr>
                <tr>
                    <td>Order results</td>
                    <td><code>order($field, $dir)</code></td>
                    <td><span class="badge bg-primary">Query</span></td>
                    <td><code>$model->order('name', 'asc')</code></td>
                </tr>
                <tr>
                    <td>Limit results</td>
                    <td><code>limit($start, $limit)</code></td>
                    <td><span class="badge bg-primary">Query</span></td>
                    <td><code>$model->limit(0, 10)</code></td>
                </tr>
                <tr>
                    <td>Eager load relationships</td>
                    <td><code>with($relations)</code></td>
                    <td><span class="badge bg-success">Model</span></td>
                    <td><code>$model->with(['doctor', 'reviews'])</code></td>
                </tr>
                <tr>
                    <td>Execute query (multiple records)</td>
                    <td><code>getResults()</code></td>
                    <td><span class="badge bg-success">Model</span></td>
                    <td><code>$model->where(...)->getResults()</code></td>
                </tr>
                <tr>
                    <td>Execute query (single record)</td>
                    <td><code>getRow()</code></td>
                    <td><span class="badge bg-success">Model</span></td>
                    <td><code>$model->where(...)->getRow()</code></td>
                </tr>
                <tr>
                    <td>Execute query (single value)</td>
                    <td><code>getVar()</code></td>
                    <td><span class="badge bg-warning">mixed</span></td>
                    <td><code>$model->select('COUNT(*)')->getVar()</code></td>
                </tr>
                <tr>
                    <td>Check if object is empty</td>
                    <td><code>isEmpty()</code></td>
                    <td><span class="badge bg-info">bool</span></td>
                    <td><code>$model->isEmpty()</code></td>
                </tr>
                <tr>
                    <td>Count result set</td>
                    <td><code>count()</code></td>
                    <td><span class="badge bg-info">int</span></td>
                    <td><code>$results->count()</code></td>
                </tr>
                <tr>
                    <td>Count total records</td>
                    <td><code>total()</code></td>
                    <td><span class="badge bg-info">int</span></td>
                    <td><code>$model->total()</code></td>
                </tr>
                <tr>
                    <td>Fill record with data</td>
                ...
                <tr>
                    <td>Navigate to first</td>
                    <td><code>first()</code></td>
                    <td><span class="badge bg-success">Model|null</span></td>
                    <td><code>$results->first()</code></td>
                </tr>
                <tr>
                    <td>Navigate to next</td>
                    <td><code>next()</code></td>
                    <td><span class="badge bg-secondary">void</span></td>
                    <td><code>$results->next()</code></td>
                </tr>
                <tr>
                    <td>Check if has next</td>
                    <td><code>hasNext()</code></td>
                    <td><span class="badge bg-info">bool</span></td>
                    <td><code>$results->hasNext()</code></td>
                </tr>
                <tr class="table-info">
                    <td colspan="4"><strong>Data Formatting</strong></td>
                </tr>
                <tr>
                    <td>Get raw data (all records)</td>
                    <td><code>getRawData($type, $all)</code></td>
                    <td><span class="badge bg-warning">array|object</span></td>
                    <td><code>$results->getRawData('array', true)</code></td>
                </tr>
                <tr>
                    <td>Get formatted data (all records)</td>
                    <td><code>getFormattedData($type, $all)</code></td>
                    <td><span class="badge bg-warning">array|object</span></td>
                    <td><code>$results->getFormattedData('array', true)</code></td>
                </tr>
                <tr>
                    <td>Get SQL data (all records)</td>
                    <td><code>getSqlData($type, $all)</code></td>
                    <td><span class="badge bg-warning">array|object</span></td>
                    <td><code>$results->getSqlData('array', true)</code></td>
                </tr>
                <tr>
                    <td>Get raw field value</td>
                    <td><code>getRaw($field)</code></td>
                    <td><span class="badge bg-warning">mixed</span></td>
                    <td><code>$model->getRaw('created_at')</code></td>
                </tr>
                <tr>
                    <td>Get formatted field value</td>
                    <td><code>getFormatted($field)</code></td>
                    <td><span class="badge bg-warning">mixed</span></td>
                    <td><code>$model->getFormatted('created_at')</code></td>
                </tr>
                <tr>
                    <td>Get SQL field value</td>
                    <td><code>getSql($field)</code></td>
                    <td><span class="badge bg-warning">mixed</span></td>
                    <td><code>$model->getSql('created_at')</code></td>
                </tr>
                <tr>
                    <td>Set output mode to raw</td>
                    <td><code>setRaw()</code></td>
                    <td><span class="badge bg-secondary">void</span></td>
                    <td><code>$model->setRaw()</code></td>
                </tr>
                <tr>
                    <td>Set output mode to formatted</td>
                    <td><code>setFormatted()</code></td>
                    <td><span class="badge bg-secondary">void</span></td>
                    <td><code>$model->setFormatted()</code></td>
                </tr>
                <tr>
                    <td>Set output mode to SQL</td>
                    <td><code>setSql()</code></td>
                    <td><span class="badge bg-secondary">void</span></td>
                    <td><code>$model->setSql()</code></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="alert alert-secondary mt-3">
        <strong>📌 Return Types Legend:</strong>
        <ul class="mb-0">
            <li><span class="badge bg-primary">Query</span> - Returns Query instance for method chaining (must call <code>getResults()</code> or <code>getRow()</code>)</li>
            <li><span class="badge bg-success">Model</span> - Returns Model instance with data (can iterate, access properties)</li>
            <li><span class="badge bg-info">bool</span> - Returns boolean (true/false)</li>
            <li><span class="badge bg-info">int</span> - Returns integer number</li>
            <li><span class="badge bg-warning">mixed</span> - Returns any type of value</li>
            <li><span class="badge bg-secondary">void</span> - Returns nothing (changes internal state)</li>
        </ul>
    </div>
