...
// Use the new token for subsequent requests
   ...
   <ul>
       <li><strong>Server Module</strong>: Handles token generation, verification and refreshing</li>
   ...
   <h2>Documenting JWT APIs</h2>
   <p><strong>Remember to document your JWT endpoints</strong> using the <code>#[ApiDoc]</code> attribute when implementing authentication APIs:</p>
