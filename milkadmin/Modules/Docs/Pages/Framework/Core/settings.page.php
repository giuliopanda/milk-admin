...
$setting = Settings::get('nonexistent') ?? 'default_value';</code></pre>
     ...
     <h4 class="mt-4">getAll($group = null)</h4>
    <p>Retrieves all data from a group as an associative array.</p>
    <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">public static function getAll(?string $group = null): array</code></pre>
    <p><strong>Parameters:</strong></p>
    <ul>
        <li><code>$group</code> - <code>String</code> (optional) - The group name (uses 'default' if null).</li>
    </ul>
...
$email_config = Settings::getAll('email');</code></pre>

     <h4 class="mt-4">hasKey($key, $group = null)</h4>
    <p>Checks if a key exists in the specified group.</p>
    <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">public static function hasKey(string $key, ?string $group = null): bool</code></pre>
    <p><strong>Parameters:</strong></p>
    <ul>
...
Settings::save();</code></pre>
    ...
    <h2>Search Methods</h2>
     ...
     <h4 class="mt-4">searchByValue($search_value, $group = null)</h4>
    <p>Searches for a value in a specific group or all groups.</p>
    <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">public static function searchByValue(mixed $search_value, ?string $group = null): array</code></pre>
    <p><strong>Parameters:</strong></p>
    <ul>
...
$email_results = Settings::searchByValue('localhost', 'email');</code></pre>
    
     <h4 class="mt-4">searchByKey($search_key, $group = null)</h4>
    <p>Searches for keys that contain a specific string.</p>
    <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">public static function searchByKey(string $search_key, ?string $group = null): array</code></pre>
    <p><strong>Parameters:</strong></p>
    <ul>
...
$smtp_settings = Settings::searchByKey('smtp', 'email');</code></pre>

    <h2>Management Methods</h2>
    
     <h4 class="mt-4">removeKey($key, $group = null)</h4>
    <p>Removes a key from a group.</p>
    <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">public static function removeKey(string $key, ?string $group = null): void</code></pre>
    <p><strong>Parameters:</strong></p>
    <ul>
...
Settings::removeKey('temp_config', 'cache');</code></pre>
    
     <h4 class="mt-4">clearGroup($group = null)</h4>
    <p>Completely empties a group by removing all settings.</p>
    <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">public static function clearGroup(?string $group = null): void</code></pre>
    <p><strong>Parameters:</strong></p>
    <ul>
        <li><code>$group</code> - <code>String</code> (optional) - The group name (uses 'default' if null).</li>
    </ul>
...
// Clear cache group
Settings::clearGroup('cache');</code></pre>
