...
<div class="bg-white p-4">
    ...
    <p>In <code>get.class.php</code> is called after all modules have been loaded, before loading the template function and before the init hook. It's used to set, for example, whether the user is logged in or not.</p>

    <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">Hooks::run('init'); </code></pre>
    <p>In <code>index.php</code>: is called after all modules have been loaded and the modules_loaded hook (which sets the user) has been executed. It runs immediately before loading the theme function</p>
