 ...
 * @guide framework
 * @order 10
 * @tags theme, template-system, Bootstrap, UI-framework, theme-customization, header, sidebar, menu-management, breadcrumbs, menu, template, toast, modal, offcanvas, javascript, hooks, permissions, theme_page, theme_plugin, GET, Theme::set, Response::theme_page
 */
...
<div class="bg-white p-4">
    ...
    <pre class="bg-light p-2"><code class="language-php">Response::themePage('default', __DIR__ . '/assets/my.page.php', ['title' => 'My Page' ...]);</code></pre>
    ...
    <div class="border p-1" style="max-width:500px">
        <img src="<?php echo Route::url(); ?>/Modules/docs/assets/theme-header-link.jpg" alt="Header link" class="border w-100">
    </div>
    ...
    <div class="d-flex align-items-center">
        <div class="flex-shrink-0 me-3">
            <div class="border p-1" style="max-width:80px">
                <img src="<?php echo Route::url(); ?>/Modules/docs/assets/theme-menu-sidebar.jpg" alt="Header link" class="border w-100">
            </div>
        </div>
    ...
    <pre class="bg-light p-2"><code class="language-php">Theme::set('header.top-left', 'my cup of milk > <a class="link-action" href="'.Route::url('?page=sugar').'">Sugar</a>');</code></pre>
    ...
    <pre class="bg-light p-2"><code class="language-php">&lt;?php echo Get::themePlugin('loading', ['id' => 'loading']); ?&gt;
&lt;script&gt;
...
&lt;/script&gt;</code></pre>
    ...
    <ul>
    <li><a href="<?php echo Route::url('?page=docs&action=Framework/Theme/theme-modal'); ?>">Modal</a></li>
    <li><a href="<?php echo Route::url('?page=docs&action=Framework/Theme/theme-offcanvas'); ?>">Offcanvas</a></li>

    <li><a href="<?php echo Route::url('?page=docs&action=Framework/Theme/theme-toasts'); ?>">Toasts</a></li>
    </ul>
    ...
    <pre class="bg-light p-2"><code class="language-php">Response::themePage('default', __DIR__ . '/cup-module/assets/milk.page.php', ['my_var'=>'drink']);</code></pre>
    ...
    <p> <a href="<?php echo Route::url('?page=docs&action=Framework/Theme/theme-javascript-components'); ?>">The theme doesn't use JavaScript frameworks, but has a series of utilities to simplify development</a>, but if desired it's possible to extend the system with any JavaScript framework you want</p>
</div>