...
<div class="bg-white p-4">
    ...
    <div class="alert alert-primary">
        ...
        <p class="mb-0">
            This is a manual, artisanal system for creating beauty select fields. If you need to create forms quickly from your Models,
    ...
    <p class="alert alert-danger">I haven't developed the required validation yet</p>
        ...
        <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">&lt;?php echo Get::themePlugin('BeautySelect', [
        'id'=>'simpleSelect', 
        'options'=>['1'=>'One', '2' => 'Two'], 
        ...
        <div class="demo-section col-xl-6">
            <?php echo Get::themePlugin('BeautySelect',['id'=>'simpleSelect', 'options'=>['1'=>'One', '2' => 'Two'], 'label'=>'Simple TomSelect', 'value'=>2] ); ?>
        </div>
       
        <h3>2. Group Select</h3>
        <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">&lt;?php echo Get::themePlugin('BeautySelect',['id'=>'groupSelect', 'floating'=>false, 'options'=>['Fruit' => ['fruit1'=>'Apple', 'fruit2' => 'Banana', 'fruit3' => 'Orange'], 'Vegetables' => ['veg1'=>'Carrot', 'veg2' => 'Broccoli', 'veg3' => 'Spinach'] ] ] ); ?&gt;</code></pre>
        <div class="demo-section col-xl-6">
...
Get::themePlugin('BeautySelect', ['id'=>'state', 'label'=>'multiple select', 'options'=>['franch' => 'franch', 'spain' => 'spain', 'italy' => 'italy'], 'isMultiple'=>true]); ?&gt;</code></pre>
        <div class="demo-section col-xl-6">
            <?php echo Get::themePlugin('BeautySelect', ['id'=>'state', 'label'=>'multiple select', 'options'=>['franch' => 'franch', 'spain' => 'spain', 'italy' => 'italy'], 'isMultiple'=>true]); ?>
        </div>

        <h4>4. showToggleButton</h4>
        <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">&lt;?php echo Get::themePlugin('BeautySelect',  ['id'=>'state', 'label'=>'showToggleButton select',  'options'=>['franch' => 'franch', 'spain' => 'spain', 'italy' => 'italy'],  'showToggleButton'=>true]); ?&gt;</code></pre>
        <div class="demo-section col-xl-6">
            <?php echo Get::themePlugin('BeautySelect', ['id'=>'state2', 'floating'=>false, 'label'=>'showToggleButton select', 'options'=>['franch' => 'franch', 'spain' => 'spain', 'italy' => 'italy'], 'showToggleButton'=>true]); ?>
        </div>
    ...
    <h4>6. onChange</h4>
    <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">&lt;?php echo Get::themePlugin('BeautySelect',['id'=>'simpleSelectChange', 'label'=>'onchange select', 'options'=>['1'=>'One', '2' => 'Two']  'onChange'=>'showInDiv(window.beautySelect.getValue("simpleSelectChange"))'] ); ?&gt;</code></pre>
        <div class="demo-section col-xl-6">
