...
<h3>2. Backend PHP</h3>
<p>In the router, the delete calls the same function that is called when generating the table. If you are extending the AbstractController, you just need to write:</p>
<pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php"> $this->callTableAction($table_id, 'delete', 'table_action_delete');</code></pre>
<p>and then create a new function</p>
<pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">protected function tableActionDelete($id, $request) {
...
<pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">protected function actionEdit() {
...
function exportData() {
    ...
    <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php"><?php echo htmlspecialchars('protected function actionHome() {
