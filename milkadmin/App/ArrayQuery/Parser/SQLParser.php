...
final class SQLParser
{
    ...
    const CLAUSES = [
        ...
        'INSERT' => true,
        'VALUES' => true,
        // DDL rimossi: DROP, SHOW, TRUNCATE, CREATE, ALTER
    ];
    ...
    /** @var array<SelectQuery|InsertQuery|UpdateQuery|DeleteQuery> */
    ...
    private static function parseImpl(string $sql)
    {
        ...
        switch ($token->value) {
            ...
            case 'INSERT':
                ...
                return $insert->parse();
            // DDL non supportati in questa versione DML-only
            // case 'TRUNCATE':
            // case 'DROP':
            // case 'SHOW':
            // case 'CREATE':
