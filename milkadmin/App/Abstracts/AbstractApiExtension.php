...
/**
 * Abstract API Extension
 *
 * Base class for API extensions that provides lifecycle hooks.
 *
 * Example usage:
 * ```php
 * class MyExtension extends AbstractApiExtension
 * {
 ...
 */
abstract class AbstractApiExtension
{
    /**
    ...
    /**
     * Hook called after the API initialization
    ...
    /**
     * Hook called after setHandleApi is called
     * Can be overridden by child classes
     *
     * @return void
     */
