 ...
 * @example
 * // Write data safely
 * if (File::putContents('data.txt', 'Hello World')) {
 *     echo "File written successfully";
 * } else {
 *     echo "Error: " . File::getLastError();
 * }
 * 
 * // Read data safely
...
class File {
     ...
     *     File::appendContents('messages.txt', $message);
     * }
     * 
     */
    public static function appendContents($file_path, $data) {
        self::$last_error = '';
     ...
     * 
     * @example
     * if (File::putContents('log.txt', "Error occurred at " . date('Y-m-d H:i:s'))) {
     ...
     * 
     */
    public static function putContents($file_path, $data) {
        self::$last_error = '';
     ...
     */
    public static function waitLock($fp, $exclusive = true) {
