...
<nav aria-label="Page navigation">
        <?php if ($pages > 1) : ?>
                    ...
                    <ul class="pagination">
                        <?php if ($actual_page > 1) : ?>
                            <li class="page-item">
                                ...
                                ?>
                                <span class="page-link list-pagination-click js-pagination-click" data-list-page="<?php echo $prev_page; ?>" aria-label="Previous">
                        ...
                        <?php for ($i = $first_page; ($i <= $pages && $i <= $actual_page + $number_of_links); $i++) : ?>
                            <li class="page-item <?php echo $i == $actual_page ? 'active' : ''; ?>">
                                <span class="page-link list-pagination-click js-pagination-click" data-list-page="<?php echo $i; ?>"><?php echo $i; ?></span>
                            </li>
                        <?php endfor; ?>
                        <?php if ($pages > $actual_page) : ?>
                            <li class="page-item">
                                ...
                                ?>
                                <span class="page-link list-pagination-click js-pagination-click" data-list-page="<?php echo $next_page; ?>" aria-label="Next">
            ...
            <?php if (($page_info['pag-goto-show'] ?? true) && $pages > 9) : ?>
                ...
                <div class="d-inline-block">
                    <select class="form-select js-pagination-select" data-list-page="select">
                        <?php
        ...
        <?php if ($page_info['pag-elperpage-show'] ?? true) : ?>
            ...
            <div class="d-inline-block">
                <select class="form-select js-pagination-el-per-page" data-list-page="limit">
                    <?php 
                    $elem_per_page = [5, 10, 15, 20, 25, 30, 40, 50, 100];
                    $elem_per_page[] = $page_info['default_limit'];
                    $elem_per_page = array_unique($elem_per_page);
                    sort($elem_per_page);
                    foreach ($elem_per_page as $limit) : ?>
