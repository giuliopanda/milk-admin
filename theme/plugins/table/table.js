...
class Table {
    ...
    handle_row_click(event) {
        ...
        row.classList.toggle('js-selected');
        
        // Update checkbox state based on row selection
        if (row.classList.contains('js-selected')) {
    ...
    tableBulkAction(el) {
        ...
        // Submit form with bulk action data
        this.sendForm();
    }
