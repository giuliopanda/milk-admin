...
<div class="bg-white p-4">
    ...
    <pre class="pre-scrollable border p-2 text-bg-gray"><code class="language-php">&lt;?php echo Get::theme_plugin('editor', [
    'id' => 'simpleEditor',
    'label' => 'Description',
    ...
    <div class="demo-section col-xl-8">
        <?php echo Get::theme_plugin('editor', [
            'id' => 'simpleEditor',
            'label' => 'Description',
            'placeholder' => 'Enter text...',
            'value' => '<p>Initial content</p>'
    ...
    <div class="demo-section col-xl-8">
        ...
        <div class="mt-3">
            <div id="charCount" class="text-muted">HTML chars: 0</div>
            <div id="plainTextCount" class="text-muted">Text chars: 0</div>
...
// &lt;?php echo Get::theme_plugin('editor', ['id' => 'myEditor']); ?&gt;
