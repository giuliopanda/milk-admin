...
&lt;/div&gt;</code></pre>
    ...
    <div class="form-group col-xl-6">
    <?php echo Get::theme_plugin('upload-files',['name'=>'file', 'label'=>'File', 'value'=>'', 'options'=>['multiple'=>true], 'upload_name' => 'my_upload2'] ); ?>
    </div>
    <pre class="pre-scrollable border p-2" class="text-bg-gray"><code class="language-php">echo Get::theme_plugin('upload-files',['name'=>'file', 'label'=>'File', 'value'=>'', 'options'=>[], 'upload_name' => 'my_upload1'] );</code></pre>
    <p>In the controller I add upload handling</p>
...
Hooks::set('upload_accept_my_upload1', function($accept) {
    ...
    <pre class="pre-scrollable border p-2" class="text-bg-gray"><code class="language-php">Get::theme_plugin('upload-files',['name'=>'file', 'label'=>'File', 'value'=>'', 'options'=>['multiple'=>true], 'upload_name' => 'my_upload2'] );</code></pre>
...
&lt;/div&gt;</code></pre>
    ...
    <br>
    <h2>checkbox</h2>
    <h5><code>Form::checkbox($name, $label, $value = '', $options = array(), $return = false)</code></h5>
    <p> $field = Hook:set('form_checkbox', $field, $name, $label, $value, $options, $return)</p>
    <div class="bg-light p-2"> 
        <div class="form-group col-xl-6">
    ...
    <pre class="pre-scrollable border p-2" class="text-bg-gray"><code class="language-php">&lt;div class=&quot;form-check&quot;&gt;Form::checkbox('myName', 'Label', '1');&lt;/div&gt;</code></pre>
