...
<div class="center-login">
    ...
    if ($msg_error != '') :?>
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <?php echo \MilkCore\Sanitize::html($msg_error); ?>
    ...
    elseif ($success == true) :?>
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="<?php echo \MilkCore\Route::url(['page'=>'auth','action'=>'login']); ?>"><?php _p('Return to Login'); ?></a>
            </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="js-needs-validation" novalidate method="post">
                ...
                <?php echo \MilkCore\Token::input('forgot_password'); ?>
                <div class="mb-3">
    ...
    <a href="<?php echo \MilkCore\Route::url(['page'=>'auth','action'=>'login']); ?>">Login</a>
</div>